...
public class Main {
    public static void main(String[] args) {
        ...
        MatrixTasks.createMatrixByZeroAndOne(6,6);
        //MatrixTasks.findNumberLine(MatrixTasks.createRandomMatrix());
        //MatrixTasks.createRandomMatrix();
        //MatrixTasks.findPositiveElementsMainDiagonal(arrays);
        //Matrix.printMatrix(matrix);

        //MatrixTasks.replaceColumnsInMatrix(matrix, 1, 2);
        //MatrixTasks.findMaxSumInColumn(matrix);

        //int[][] myMatrix = MatrixTasks.createMatrixN(6);
        //int[][] myMatrix = MatrixTasks.createMatrixByCondition(6);
        //int[][] myMatrix = MatrixTasks.createMatrixBySecondCondition(6);
        ...
        //Basic.findMaxValueFromMin(5,3,8,4);
        //Basic.isPointsOnLine(1,4,2,3,4,1);
        //Basic.resolveCanBrickEnterTheHole(9,9,9,9,9);
        //Basic.checkIfTriangleExistsAndRectangular(30,60);
        //Basic.findSum(0.1);
        //Basic.findDivisorsForNumbersInRangeExceptZeroAndItself(-10,10);
        //Basic.findDigitsInFirstAndSecondNumbers(34561277,625178);
